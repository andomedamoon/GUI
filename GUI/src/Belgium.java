...
public class Belgium extends JFrame implements ActionListener {

    Timer time;
    public static final int POPULATION = 11_400_000;
    ...
    public Belgium() {
        ...
        ActionListener counter = new belgiumInfectionsUpdater();
    ...
    class belgiumInfectionsUpdater implements ActionListener {

        @Override
        public void actionPerformed(ActionEvent e) {

            infections2.setText(String.valueOf(BelgiumInfections.getInfections()));
            recovered2.setText(String.valueOf(BelgiumInfections.recovered));
