...
public class France extends JFrame implements ActionListener {
    ...
    Timer time;
    public static final int POPULATION = 67_000_000;
    ...
    public France() {
        ...
        ActionListener counter = new franceInfectionsUpdater();
    ...
    class franceInfectionsUpdater implements ActionListener {

        @Override
        public void actionPerformed(ActionEvent e) {

            infections2.setText(String.valueOf(FranceInfections.getInfections()));
            recovered2.setText(String.valueOf(FranceInfections.recovered));
