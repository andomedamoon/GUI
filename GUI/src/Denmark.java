...
public class Denmark extends JFrame implements ActionListener {
    ...
    Timer time;
    public static final int POPULATION = 5_800_000;
    ...
    public Denmark() {
        ...
        ActionListener counter = new denmarkInfectionsUpdater();
    ...
    class denmarkInfectionsUpdater implements ActionListener {

        @Override
        public void actionPerformed(ActionEvent e) {

            infections2.setText(String.valueOf(DenmarkInfections.getInfections()));
            recovered2.setText(String.valueOf(DenmarkInfections.recovered));
