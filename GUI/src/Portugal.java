...
public class Portugal extends JFrame implements ActionListener {

    Timer time;
    public static final int POPULATION = 10_200_000;
    ...
    public Portugal() {
        ...
        ActionListener counter = new portugalInfectionsUpdater();
    ...
    class portugalInfectionsUpdater implements ActionListener {

        @Override
        public void actionPerformed(ActionEvent e) {

            infections2.setText(String.valueOf(PortugalInfections.getInfections()));
            recovered2.setText(String.valueOf(PortugalInfections.recovered));
