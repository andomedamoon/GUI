...
public class Austria extends JFrame implements ActionListener {

    Timer time;
    public static final int POPULATION = 8_800_000;
    ...
    public Austria() {
        ...
        ActionListener counter = new austriaInfectionsUpdater();
    ...
    class austriaInfectionsUpdater implements ActionListener {

        @Override
        public void actionPerformed(ActionEvent e) {

            infections2.setText(String.valueOf(AustriaInfections.getInfections()));
            recovered2.setText(String.valueOf(AustriaInfections.recovered));
