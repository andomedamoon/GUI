...
public class UKInfections extends Thread {
    ...
    public void run() {
        while (infections <= 66_600_000) {
            ...
            if (infections > 66_600_000) {
                infections = 66_600_000;
                return;
    ...
    public static void divideMultiple(int multiple) {
        UKInfections.multiple = UKInfections.multiple / multiple;
    }
