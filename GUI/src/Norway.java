...
public class Norway extends JFrame implements ActionListener {

    Timer time;
    public static final int POPULATION = 5_300_000;
    ...
    public Norway() {
        ...
        ActionListener counter = new norwayInfectionsUpdater();
    ...
    class norwayInfectionsUpdater implements ActionListener {

        @Override
        public void actionPerformed(ActionEvent e) {

            infections2.setText(String.valueOf(NorwayInfections.getInfections()));
            recovered2.setText(String.valueOf(NorwayInfections.recovered));
