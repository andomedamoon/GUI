...
public class Luxembourg extends JFrame implements ActionListener {

    Timer time;
    public static final int POPULATION = 610_000;
    ...
    public Luxembourg() {
        ...
        ActionListener counter = new luxembourgInfectionsUpdater();
    ...
    class luxembourgInfectionsUpdater implements ActionListener {

        @Override
        public void actionPerformed(ActionEvent e) {

            infections2.setText(String.valueOf(LuxembourgInfections.getInfections()));
            recovered2.setText(String.valueOf(LuxembourgInfections.recovered));
