...
public class Ireland extends JFrame implements ActionListener {

    Timer time;
    public static final int POPULATION = 4_900_000;
    ...
    public Ireland() {
        ...
        ActionListener counter = new irelandInfectionsUpdater();
    ...
    class irelandInfectionsUpdater implements ActionListener {

        @Override
        public void actionPerformed(ActionEvent e) {

            infections2.setText(String.valueOf(IrelandInfections.getInfections()));
            recovered2.setText(String.valueOf(IrelandInfections.recovered));
