...
public class Germany extends JFrame implements ActionListener {


    Timer time;
    public static final int POPULATION = 82_000_000;
    ...
    public Germany() {
        ...
        ActionListener counter = new germanyInfectionsUpdater();
    ...
    class germanyInfectionsUpdater implements ActionListener {

        @Override
        public void actionPerformed(ActionEvent e) {

            infections2.setText(String.valueOf(GermanyInfections.getInfections()));
            recovered2.setText(String.valueOf(GermanyInfections.recovered));
