...
public class Netherlands extends JFrame implements ActionListener {

    Timer time;
    public static final int POPULATION = 17_700_000;
    ...
    public Netherlands() {
        ...
        ActionListener counter = new netherlandsInfectionsUpdater();
    ...
    class netherlandsInfectionsUpdater implements ActionListener {

        @Override
        public void actionPerformed(ActionEvent e) {

            infections2.setText(String.valueOf(NetherlandsInfections.getInfections()));
            recovered2.setText(String.valueOf(NetherlandsInfections.recovered));
