...
public class Finland extends JFrame implements ActionListener {

    Timer time;
    public static final int POPULATION = 5_500_000;
    ...
    public Finland() {
        ...
        ActionListener counter = new finlandInfectionsUpdater();
    ...
    class finlandInfectionsUpdater implements ActionListener {

        @Override
        public void actionPerformed(ActionEvent e) {

            infections2.setText(String.valueOf(FinlandInfections.getInfections()));
            recovered2.setText(String.valueOf(FinlandInfections.recovered));
