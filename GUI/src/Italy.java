...
public class Italy extends JFrame implements ActionListener {

    Timer time;
    public static final int POPULATION = 60_000_000;
    ...
    public Italy() {
        ...
        ActionListener counter = new italyInfectionsUpdater();
    ...
    class italyInfectionsUpdater implements ActionListener {

        @Override
        public void actionPerformed(ActionEvent e) {

            infections2.setText(String.valueOf(ItalyInfections.getInfections()));
            recovered2.setText(String.valueOf(ItalyInfections.recovered));
