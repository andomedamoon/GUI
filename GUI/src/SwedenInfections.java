...
public class SwedenInfections extends Thread {
    ...
    public SwedenInfections() {
        start();

        JOptionPane.showMessageDialog(null, "THE VIRUS APPEARED IN SWEDEN!");
    }
    ...
    public static void divideMultiple(int multiple) {
        SwedenInfections.multiple = SwedenInfections.multiple / multiple;
    }
