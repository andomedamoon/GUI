...
public class Sweden extends JFrame implements ActionListener {
    ...
    public Sweden() {
        ...
        ActionListener counter = new swedenInfectionsUpdater();
    ...
    class swedenInfectionsUpdater implements ActionListener {

        @Override
        public void actionPerformed(ActionEvent e) {

            infections2.setText(String.valueOf(SwedenInfections.getInfections()));
            recovered2.setText(String.valueOf(SwedenInfections.recovered));
